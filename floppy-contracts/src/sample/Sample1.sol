...
// import "@interfaces/IFloppyCommission.sol";
// import { RONTransferHelper } from "./libraries/transfers/RONTransferHelper.sol";

// contract FloppyCommission is Initializable, AccessControlEnumerable, IFloppyCommission {
...
//     uint256 commissionIdx,
//     address payable newRecipient,
//     string calldata newName
//   ) external onlyRole(DEFAULT_ADMIN_ROLE) {
//     if (commissionIdx >= _commissionInfos.length) {
...
//     for (uint256 i; i < length; ++i) {
//       if (commissionInfos[i].recipient == address(0)) {
//         revert NullAddress();
//       }
